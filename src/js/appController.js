...
define(['knockout', 'ojs/ojmodule-element-utils', 'ojs/ojknockouttemplateutils', 'ojs/ojrouter', 'ojs/ojresponsiveutils', 'ojs/ojresponsiveknockoututils', 'ojs/ojarraydataprovider',
        'ojs/ojoffcanvas', 'text!config/appconfig.json', 'ojs/ojmodule-element', 'ojs/ojknockout'],
  function(ko, moduleUtils, KnockoutTemplateUtils, Router, ResponsiveUtils, ResponsiveKnockoutUtils, ArrayDataProvider, OffcanvasUtils, appconfig) {
      ...
      */
      ...
      self.mdScreen = ResponsiveKnockoutUtils.createMediaQueryObservable(mdQuery);
       ...
       self.router.configure({
         'employees': {label: 'Employees', isDefault: true}
       });
      ...
      */
      ...
      self.appName = ko.observable("Red Samurai Consulting");
      // User Info used in Global Navigation area
      self.userLogin = ko.observable("andrej.baranovskij");
